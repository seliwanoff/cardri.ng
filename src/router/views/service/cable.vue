...
export default {
  ...
  methods: {
    ...
    HandleSubmit() {
      if (parseInt(this.balance) >= parseInt(this.plan.amount)) {
        ...
        const data = {
          ...
          networkname: this.plan.networkname,
          amount: this.plan.amount,
          reciever: this.phone,
          type: 5,
          tfee: this.tfee,
          plan: this.plan.networkname,
          planid: this.plan.id,
          status: 1,
    ...
    getAmontForCommission(amt) {
      this.discount = Math.floor(this.commission * parseInt(amt));
    },
  },
};
</script>
        ...
        <b-card>
          <div class="d-lg-flex justify-content-between">
            ...
            <b-card class="w-100 glvl">
              ...
              <div v-else style="text-align: center">No cable yet</div>
            </b-card>
          </div>
        </b-card>
      </div>
